/*
Dev Practice - Remove Duplicates from Sorted Array I:
...
func main() {
	// fmt.Println("Response: ", removeDuplicates([]int{1, 1, 2})) // response 2 - 1,2,_
	fmt.Println("Response: ", removeDuplicates([]int{0, 0, 1, 1, 1, 2, 2, 3, 3, 4})) // response 5 - 0,1,2,3,4,_,_,_,_,_
}
